...
const BroadcastPage = () => {
  ...
  const fileUrl = location.pathname === '/broadcast' ? 'broadcast' : location.pathname.split('/')[2];
  console.log(fileUrl);
  ...
  return (
    <section className="broadcasts-wrapper">
      ...
      <div className="section-widgets">
        ...
        {fileUrl === 'testimony-of-jesus' && <VideosComponent data_source={getVideosByCategoryName} category={fileUrl}/>}
      </div>
    </section>
  );
};
