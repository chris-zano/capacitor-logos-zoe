    ...
    <>
      <article className="d-chapter">
        ...
        <section className="message-sect">
          ...
          <div
            className="theme-scripture"
            dangerouslySetInnerHTML={{
              __html: devotional.type === "new" ? devotional.scripture : "",
            }}
          ></div>

          <strong className="theme-scripture-header">
            {devotional.type === "new" ? "PREPARATORY QUESTION:" : ""}
          </strong>
          <div
            className="theme-scripture"
            dangerouslySetInnerHTML={{
              __html: devotional.type === "new" ? devotional.questions : "",
            }}
          ></div>
